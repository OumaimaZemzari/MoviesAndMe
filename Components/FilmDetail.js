...
import toggleVus from "../Store/Reducers/vusReducer";
...
class FilmDetail extends React.Component {
    ...
    constructor(props) {
        ...
        this._toggleVus = this._toggleVus.bind(this)
    ...
    _toggleVus(){
     ...
     _displayVusButton() {
        ...
        if (this.props.vusFilm.findIndex(item => item.id === this.state.film.id) !== -1) {
           title="Deja vu"
